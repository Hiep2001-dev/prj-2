                        ...
                        <tbody>
                            ...
                            @foreach ($order_details as $order_detail)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('user.products_detail', $order_detail->product_id) }}">{{ $order_detail->product_name }}</a>
                                    </td>
                                    <td class="text-center">
                                        <img style="width: 70px; height:auto; object-fit: cover;"
                                            src="{{ asset("asset/client/images/products/small/$order_detail->product_img") }}"
                                            alt="">
                                    </td>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: 600;">
                                    {{ format_number_to_money($infomationUser->orders_transport_fee) }} VND</td>
                            </tr>
                            <tr>
                                <td colspan="7">Giảm giá</td>
                                <td style="font-weight: 600;">
                                    - {{ format_number_to_money($infomationUser->orders_transport_fee + $totalProductMoney - $order->total_money) }}
                                    VND</td>
                            </tr>
                            <tr>
