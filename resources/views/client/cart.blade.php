...
<div class="container">
  <div class="row ">
    @if (count(\Cart::getContent()) <= 0)
      <h3 class="text-center mt_20">Giỏ hàng của bạn đang không có sản phẩm nào</h3>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div style="max-width: 200px;" class="input-group btn-block">
                          <input type="number" class="form-control quantity" size="1" value="{{ $cart->quantity }}" name="quantity" min=1>
                        </div>
                      </td>
