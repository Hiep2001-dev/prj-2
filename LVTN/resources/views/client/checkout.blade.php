                                        ...
                                        <select class="form-control form-select" id="city" name="city">
                                            @foreach ($citys as $item)
                                                <option value="{{ $item['ProvinceID'] }}"
                                                    @if ($item['ProvinceID'] == $city) selected @endif>
                                        ...
                                        <select class="form-control form-select" id="district" name="district">
                                            @foreach ($districts as $item)
                                                <option value="{{ $item['DistrictID'] }}"
                                                    @if ($item['DistrictID'] == $district) selected @endif>
                                        ...
                                        <select class="form-control form-select" id="ward" name="ward">
                                            @foreach ($wards as $item)
                                                <option value="{{ $item['WardCode'] }}"
                                                    @if ($item['WardCode'] == $ward) selected @endif>
                                ...
                                <div class="step-description">
                                    <div class="your-details">
                                        ...
                                        <div class="info-order">
                                            ...
                                            <button type="button" id="apply-voucher" class="btn btn-primary mt-2">Áp
                                                dụng</button>
                                            <a href="{{ route('checkout.index') }}">
                                                <button type="button" id="apply-voucher" class="btn btn-warning mt-2">
                                                    Hủy áp dụng
                                                </button>
                                            </a>
                                            <span id="discount-message" style="color: red; display: none;"></span>
                                        </div>
