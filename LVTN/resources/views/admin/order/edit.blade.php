...
@section('content')
                    ...
                    <div class="card card-default">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($order_details as $order_detail)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ format_number_to_money($order_detail->unit_price * $order_detail->quantity) }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b>{{ format_number_to_money($infomation_user['orders_transport_fee']) }}
                                                            VND</b></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7">Giảm giá</td>
                                                    <td>
                                                        <b>-{{ format_number_to_money($infomation_user['orders_transport_fee'] + $totalProductMoney - $order->total_money) }}
                                                            VND
                                                        </b>
                                                    </td>
                                                </tr>
                        ...
                        <div class="action col-md-12"
                            ...
                            @if ($order->order_status != 3)
                                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modal-lg">Xử Lý Đơn
                                    Hàng</button>
                            @endif
    ...
    <div id="data-order" info-customer="{{ json_encode($infomation_user) }}" products="{{ json_encode($order_details) }}">
    </div>
